...
![thingdata-logo-sq.png](/wiki/thingdata-logo-sq.png){.align-right}
...
ThingData is a spin-off of my [PhD investigation](/wiki/opendott) (Northumbria University / Mozilla Foundation) in a project funded by the Marie Curie Programme / H2020. During four years, I conducted design research studies to acquire a system-based view on the reuse of things and materials, and created a series of design concepts in response. I have investigated social and conceptual aspects of waste prevention through community-based practices of material reuse and its systemic conditions and implications.
...
- [Repair Journey](/wiki/opendott/studies/repair-journey).
- [Ecosystem Mapping](/wiki/opendott/studies/ecosystem-mapping).
- [reuse.city](/wiki/opendott/studies/reuse-city) co-design lab.

It is connected with the following concept ideas and prototypes:

- [Reuse Datasets](/wiki/opendott/concepts/reuse-datasets)
- [Universal Registry of Things](/wiki/opendott/concepts/universal-registry-things)
