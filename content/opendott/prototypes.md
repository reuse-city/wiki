...
> The text below is outdated. The experience prototype will be integrated with the [reuse.city lab](/wiki/opendott/studies/reuse-city).

## Objectives

~~Through the workshops conducted during the [reuse city lab](/wiki/opendott/studies/reuse-city) in April 2021, new co-design concepts based on the original [concept ideas](/wiki/opendott/concept-ideas) were developed. Two of them were turned into prototypes: [ThingWiki](/wiki/opendott/prototypes/thingwiki) (an experimental implementation of the Universal Registry of Things) and [E-I](/wiki/opendott/prototypes/e-i) (an evaluation interface based on two earlier [concept ideas](/wiki/opendott/concept-ideas)).~~
...
~~The experience prototype will invite the same participants who signed up the consent form for the [reuse city co-design lab](/wiki/opendott/studies/reuse-city). New participants will be able to join as long as they fill the consent form.~~
