...
*Notes from prototyping experiments conducted alongside the [reuse.city](/wiki/opendott/studies/reuse-city) co-design lab.*

![](/wiki/opendott/images/valooe-sketch.jpg)
...
- E-I compares images and other information collected from the product/object (weight, colors, barcode, QR code) against a database such as the [universal registry of things](/wiki/opendott/concepts/universal-registry-things)
...
![E-I Workbench number 1](/wiki/opendott/images/20210423_E-I_workbench.png)
...
![Unicorn](/wiki/opendott/images/20210423_unicorn.jpg)
...
Original concept:  [Point and Reuse](/wiki/opendott/concepts/point-reuse), created in previous phases of research.

![](/wiki/opendott/images/valooe.png)
